...
var (
	helpEmbed = &discordgo.MessageEmbed{
		...
		Fields: []*discordgo.MessageEmbedField{
			...
			{Name: "How do I fill out these fields?", Value: "Run `$bio [field] [value]`. For example, `$bio Pronouns She/Her` would set the Pronouns field of your Bio to \"She/Her\".\n\nTo remove a field, run `$bio [field]` with no other arguments."},
	...
	systemHelpEmbed = &discordgo.MessageEmbed{
		...
		Fields: []*discordgo.MessageEmbedField{
			...
			{Name: "Deleting a system member bio", Value: "To delete a system member bio, simply remove every field that's present in it using `$bio <member ID> <field>`. This will trigger the bot to automatically delete the bio entry from the database."},
